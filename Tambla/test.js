...
var row1 = '';
var row2 = '';
var row3 = '';//created blank boxes//
var row1a = [0, 0, 0, 0, 0, 0, 0, 0, 0];
var row2a = [0, 0, 0, 0, 0, 0, 0, 0, 0];
var row3a = [0, 0, 0, 0, 0, 0, 0, 0, 0];//pushed blank attributes//
var randnum = 0;//created random number//
var numdone = [0];
var numdone02 = [0];
var numdone1 = [0];
var numdone2 = [0];
...
//============================================================================
for (var i = 0; i < 3; i++) {
  randnum = Math.floor(Math.random() * 90 + 1); 20
...
targetButton.addEventListener("click", e => {
  ...
  if ((myVariable.length >= 9)) { alert("Game Over You Win") };
